          ...
          return (
            ...
            >
              {isHovered ? (
                ...
                <div
                  className={`w-20 md:w-24 h-72 md:h-80 bg-gradient-to-b ${course.color} rounded-xl flex items-center justify-center text-white font-semibold shadow-md transition-transform transform -rotate-6`}
                  style={{
